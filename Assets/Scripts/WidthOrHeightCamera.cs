...
//Работает как канвас скейлер, чтобы при изменении соотношения сторон игра растягивалась не в ширину а в высоту.
public class WidthOrHeightCamera : MonoBehaviour
{
